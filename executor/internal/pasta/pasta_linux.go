...
type SetupOptions struct {
	...
	ExtraOptions []string
	// CgroupFD, if non-zero, starts the pasta process in the specified
	// cgroup. The forked pasta daemon inherits the cgroup, which allows
	// eBPF programs to be attached to it for traffic interception.
	CgroupFD int
}
