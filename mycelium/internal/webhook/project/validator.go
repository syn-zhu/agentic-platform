...
var _ admission.Validator[*v1alpha1.MyceliumEcosystem] = &Validator{}

func (v *Validator) ValidateCreate(_ context.Context, _ *v1alpha1.MyceliumEcosystem) (admission.Warnings, error) {
	return nil, nil
}

func (v *Validator) ValidateUpdate(_ context.Context, _, _ *v1alpha1.MyceliumEcosystem) (admission.Warnings, error) {
	return nil, nil
}

// ValidateDelete checks that no Tools, CredentialProviders, or Agents exist
// in the project's namespace.
func (v *Validator) ValidateDelete(ctx context.Context, proj *v1alpha1.MyceliumEcosystem) (admission.Warnings, error) {
	ns := proj.Name
